      ...
      <section className="bg-gradient-to-b from-[#061A4A] to-[#0B3095] text-white py-16 sm:py-20 relative overflow-hidden border-b border-[#0B3095]">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10 space-y-4">
          ...
          <motion.p
            ...
            className="font-serif-display text-xl sm:text-2xl text-amber-200/90 font-medium"
          >
          ...
          >
            Dedicated to the revival of the pristine Prophetic Sunnah, the instruction of silent heart remembrance (Zikr-e-Qalbi), and guiding seekers towards genuine spiritual devotion at Dargah Allahabad Sharif, Sindh.
          </motion.p>
        </div>
      </section>

      {/* Main Content Body */}
      <main className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-16 space-y-16">
        ...
        <section className="grid grid-cols-1 md:grid-cols-12 gap-8 md:gap-12 items-center">
          ...
          <div className="md:col-span-5 flex justify-center">
            <div className="w-full max-w-xs sm:max-w-sm rounded-2xl bg-[#F7F9FF] border border-[#E4E9F2] p-4 sm:p-5 shadow-sm text-center">
              <div className="rounded-xl overflow-hidden bg-white border border-[#E4E9F2] shadow-2xs mb-4">
                <img
              ...
              <div className="font-serif-display text-lg font-bold text-[#0B3095]">
                Sajjan Saeen
              </div>
        ...
        <section className="bg-[#F7F9FF] rounded-2xl border border-[#E4E9F2] p-6 sm:p-8 md:p-10 space-y-4">
          ...
          >
            Sajjan Saeen and Dargah Allahabad Sharif
          </h2>

          <div className="w-12 h-[2px] bg-[#C5A15A]" />

          <div className="grid grid-cols-1 md:grid-cols-12 gap-6 pt-2 items-center">
            <div className="md:col-span-8 space-y-3 text-sm sm:text-base text-[#334155] leading-relaxed">
              <p>
                Dargah Allahabad Sharif, located in Kandiaro, Sindh, Pakistan, is the central seat of the Tahiri order. Under Sajjan Saeen’s stewardship, the sanctuary continues to serve as a haven of worship, scholarly instruction, continuous congregational Langar (free communal meals), and daily assemblies of silent Dhikr.
              </p>
              <p>
                Every year, pilgrims gather at Dargah Allahabad Sharif for the Annual Urs Mubarak, seeking spiritual renewal and deepening their practice of Islamic teachings.
              </p>
            </div>

            <div className="md:col-span-4 bg-white rounded-xl border border-[#E4E9F2] p-4 text-center space-y-3">
        ...
        <section className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 pt-2">
            <div className="bg-white rounded-xl border border-[#E4E9F2] p-5 shadow-2xs space-y-2">
              <h3 className="font-serif-display text-lg font-bold text-[#0B3095]">
                Pristine Sunnah
              </h3>
