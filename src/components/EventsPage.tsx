      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto space-y-4 mb-12 lg:mb-16">
          ...
          <h1
            ...
            className="font-serif-display text-4xl sm:text-5xl lg:text-6xl font-bold tracking-tight text-[#0B3095] leading-tight"
          >
            Events &amp; Programs
          </h1>
        ...
        {/* ==================================================
            ...
            ================================================== */}
        <section id="featured-event-section" className="mb-20">
          ...
          <motion.div
            ...
            className="rounded-3xl bg-[#F7F9FF] border border-[#E4E9F2] shadow-sm hover:shadow-md transition-all duration-300 overflow-hidden"
          >
            <div className="grid grid-cols-1 lg:grid-cols-12 items-center">
              
              {/* Left Column: Authentic Dargah Photograph Visual */}
              <div className="lg:col-span-5 relative h-72 sm:h-96 lg:h-full overflow-hidden bg-[#061A4A]">
                <img
                ...
                <div className="absolute bottom-4 left-4 px-3 py-1 rounded-md bg-black/60 backdrop-blur-xs text-white text-[11px] font-medium">
                  Dargah Allahabad Sharif, Sindh
                </div>
              </div>

              {/* Right Column: Refined Content & Three Date Presentation */}
              <div className="lg:col-span-7 p-6 sm:p-8 lg:p-12 space-y-6 text-left">
                ...
                <div className="flex flex-wrap items-center gap-2.5">
                  {featuredStatus === 'ONGOING' ? (
                    ...
                    <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-semibold bg-[#5B6472] text-white">
                      Past Event
                    </span>
                  )}
                </div>
                ...
                <div className="space-y-1">
                  <h3 className="font-serif-display text-3xl sm:text-4xl font-bold tracking-tight text-[#0B3095] leading-tight">
                    {featuredEvent.title}
                  </h3>
                  <div className="text-lg sm:text-xl font-serif-display font-medium text-[#C5A15A]">
                ...
                <div className="grid grid-cols-3 gap-3 max-w-sm">
                  <div className="p-2.5 rounded-xl bg-white border border-[#E4E9F2] text-center shadow-2xs">
                    <div className="font-serif-display text-2xl font-bold text-[#0B3095]">27</div>
                    <div className="text-[10px] font-bold uppercase tracking-wider text-[#5B6472]">
                      NOV 2026
                    </div>
                  </div>
                  <div className="p-2.5 rounded-xl bg-white border border-[#E4E9F2] text-center shadow-2xs">
                    <div className="font-serif-display text-2xl font-bold text-[#0B3095]">28</div>
                    <div className="text-[10px] font-bold uppercase tracking-wider text-[#5B6472]">
                      NOV 2026
                    </div>
                  </div>
                  <div className="p-2.5 rounded-xl bg-white border border-[#E4E9F2] text-center shadow-2xs">
                    <div className="font-serif-display text-2xl font-bold text-[#0B3095]">29</div>
                    <div className="text-[10px] font-bold uppercase tracking-wider text-[#5B6472]">
                      NOV 2026
                    </div>
                  </div>
                ...
                <div className="flex items-center gap-2 text-sm text-[#111827] font-medium">
                  <MapPin className="w-4 h-4 text-[#0B3095]" />
                  <span>Dargah Allahabad Sharif, Kandiaro, Sindh, Pakistan</span>
                </div>

                {/* Live Countdown if Upcoming */}
                {featuredStatus === 'UPCOMING' && (
                  <div className="p-3.5 rounded-xl bg-white border border-[#E4E9F2] flex items-center justify-between text-xs text-[#5B6472]">
                    <div className="flex items-center gap-1.5 font-semibold text-[#0B3095]">
                      <Clock className="w-4 h-4" />
                      <span>Starts in:</span>
                    </div>
                    <div className="font-serif-display text-sm sm:text-base font-bold text-[#0B3095]">
          ...
          <section id="upcoming-events-section" className="mb-20">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {upcomingEvents.map((evt) => (
                <div
                  key={evt.id}
                  className="p-6 rounded-2xl bg-white border border-[#E4E9F2] shadow-2xs hover:shadow-md hover:-translate-y-1 transition-all duration-300 space-y-4 text-left flex flex-col justify-between"
                >
                  <div className="space-y-3">
                    <div className="flex items-center justify-between">
                      <span className="px-2.5 py-0.5 rounded-full text-[11px] font-semibold bg-[#EEF3FF] text-[#0B3095]">
                    ...
                    <h3 className="font-serif-display text-xl font-bold text-[#0B3095]">
                      {evt.title}
                    </h3>
                  ...
                  <div className="pt-3 border-t border-[#E4E9F2] flex items-center justify-between">
        ...
        {/* ==================================================
            ...
            ================================================== */}
        <section id="monthly-programs-section" className="mb-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {monthlyPrograms.map((prog) => (
              <div
                key={prog.id}
                className="p-6 sm:p-8 rounded-2xl bg-[#F7F9FF] border border-[#E4E9F2] shadow-2xs hover:shadow-sm transition-all duration-300 space-y-4 text-left flex flex-col justify-between"
              >
                <div className="space-y-3">
                  <div className="flex items-center justify-between">
                    <span className="px-3 py-1 rounded-full text-[11px] font-semibold bg-white border border-[#E4E9F2] text-[#0B3095]">
                      {prog.recurringInterval}
                    </span>
                    <div className="w-8 h-8 rounded-lg bg-white border border-[#E4E9F2] flex items-center justify-center text-[#0B3095]">
                  ...
                  <h3 className="font-serif-display text-xl sm:text-2xl font-bold text-[#0B3095]">
                    {prog.title}
                  </h3>
                  <div className="text-xs font-semibold text-[#C5A15A] uppercase tracking-wider">
                    {prog.subtitle}
                  </div>
                ...
                <div className="pt-4 border-t border-[#E4E9F2] space-y-2 text-xs text-[#5B6472]">
                  <div className="flex items-center gap-2">
                  ...
                  <div className="pt-2 flex items-center justify-between">
                    <span className="text-[11px] text-[#5B6472]/80 italic">
        ...
        {/* ==================================================
            ...
            ================================================== */}
        <section id="past-events-section" className="mb-12">
          <div className="flex items-center gap-2 mb-6">
          ...
          <div className="divide-y divide-[#E4E9F2] bg-white rounded-2xl border border-[#E4E9F2] overflow-hidden">
            {pastEvents.map((pe) => (
              <div
                key={pe.id}
                className="p-5 sm:p-6 flex flex-col sm:flex-row sm:items-center justify-between gap-4 hover:bg-[#F7F9FF] transition-colors text-left"
              >
                <div className="space-y-1">
                  ...
                  <h4 className="font-serif-display text-lg font-bold text-[#111827]">
                    {pe.title}
                  </h4>
                ...
                <div className="flex items-center gap-3">
                  <button
                    ...
                    className="px-4 py-2 rounded-lg border border-[#E4E9F2] hover:border-[#0B3095] text-[#0B3095] text-xs font-semibold transition-colors focus:outline-none"
                  >
                    View Record
                  </button>
                </div>
