      ...
      <div className="desktop-container max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 sm:gap-8 md:gap-10 lg:gap-14 items-start">
          ...
          <motion.div
            ...
            className="lg:col-span-7 space-y-3.5 sm:space-y-4 lg:space-y-5 text-xs sm:text-sm md:text-base lg:text-[16px] leading-relaxed text-[#111827]/85"
          >
            <p>
        ...
        {/* Institutional Pillars: Responsive balanced grid for Tablet and Mobile, 3-col ONE ROW on Desktop */}
        <div className="mt-6 sm:mt-10 lg:mt-14 pt-5 sm:pt-8 lg:pt-10 border-t border-[#E4E9F2] grid grid-cols-1 sm:grid-cols-2 desktop-grid-3 gap-3 sm:gap-4 lg:gap-6">
          <motion.div
            initial={{ opacity: 0, y: 14 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            transition={{ duration: 0.5 }}
            className="p-3.5 sm:p-5 lg:p-6 rounded-xl sm:rounded-2xl bg-[#F7F9FF] border border-[#E4E9F2] space-y-1.5 sm:space-y-2"
          >
            ...
            <h3 className="font-serif-display text-sm sm:text-base md:text-lg lg:text-[20px] font-bold text-[#0B3095]">Direct Sacred Lineage</h3>
            <p className="text-xs sm:text-sm lg:text-[14px] text-[#5B6472] leading-relaxed">
          ...
          >
            ...
            <h3 className="font-serif-display text-sm sm:text-base md:text-lg lg:text-[20px] font-bold text-[#0B3095]">Authentic Texts</h3>
            <p className="text-xs sm:text-sm lg:text-[14px] text-[#5B6472] leading-relaxed">
          ...
          <motion.div
            ...
            className="p-3.5 sm:p-5 lg:p-6 rounded-xl sm:rounded-2xl bg-[#F7F9FF] border border-[#E4E9F2] space-y-1.5 sm:space-y-2 sm:col-span-2 sm:max-w-md sm:mx-auto desktop-col-span-1 w-full"
          >
            <div className="w-7 h-7 sm:w-8 sm:h-8 rounded-lg sm:rounded-xl bg-white border border-[#E4E9F2] flex items-center justify-center text-[#0B3095]">
              <Heart className="w-3.5 h-3.5 sm:w-4 sm:h-4" aria-hidden="true" focusable="false" />
            </div>
            <h3 className="font-serif-display text-sm sm:text-base md:text-lg lg:text-[20px] font-bold text-[#0B3095]">Zikr-e-Qalbi &amp; Adab</h3>
            <p className="text-xs sm:text-sm lg:text-[14px] text-[#5B6472] leading-relaxed">
