...
export const SpiritualReflectionSection: React.FC = () => {
  return (
    <section
      ...
      className="py-24 lg:py-32 bg-[#061A4A] text-white relative overflow-hidden"
    >
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-[#0B3095]/30 rounded-full blur-3xl pointer-events-none" />
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
        ...
        >
          <p
            ...
            dir="rtl"
            className="font-arabic text-3xl sm:text-4xl lg:text-5xl text-white font-normal leading-[1.8] tracking-wide"
          >
        ...
        <div className="flex items-center justify-center gap-3">
          <div className="h-[1px] w-12 bg-[#C5A15A]/40" />
          <span className="text-xs uppercase tracking-widest text-[#C5A15A] font-semibold">
            Surah Ar-Ra’d • 13:28
          </span>
          <div className="h-[1px] w-12 bg-[#C5A15A]/40" />
        </div>
        ...
        <motion.blockquote
          ...
          className="font-serif-display text-xl sm:text-2xl lg:text-3xl text-white/95 italic font-normal my-8 max-w-3xl mx-auto leading-relaxed"
        >
        ...
        <motion.div
          ...
          className="max-w-2xl mx-auto space-y-4 text-xs sm:text-sm text-white/75 leading-relaxed"
        >
          <p>
          ...
          <p className="font-serif-display text-base sm:text-lg text-[#C5A15A] italic">
            “Cleanse the vessel of the heart through silent invocation, and it shall reflect the light of the eternal Beloved.”
          </p>
        </motion.div>

        <OrnamentalDivider light accent="gold" className="mt-12" />
